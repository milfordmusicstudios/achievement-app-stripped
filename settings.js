...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // ✅ Normalize roles to ensure Switch Role works
  ...
  // ✅ Show Switch Role only if multiple roles
  if (roles.length > 1) {
  ...
  // ✅ Show Switch User (keep original visibility logic)
  ...
  // ✅ Switch User Button → No redirect (fixed)
  switchUserBtn.addEventListener("click", () => {
    alert("Switch User logic goes here. (No external page required)");
    // Optionally implement local user selection logic here
  });
});
