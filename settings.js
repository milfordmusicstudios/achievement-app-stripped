...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const roleList = viewerContext?.accountRoles || viewerContext?.viewerRoles || [];
  ...
  if (studioSection) {
    ...
    const holder = await isAccountHolder(studioId);
    studioSection.style.display = holder ? "block" : "none";
  }
